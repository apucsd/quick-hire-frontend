        ...
        <div className="bg-[#F8F9FB]">
            ...
            <header className="bg-white border-b border-slate-100 py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-[38px] md:text-[64px] font-clash-display font-semibold text-[#25324B] mb-4">
                    ...
                    <div className="bg-white p-3  shadow-2xl shadow-blue-900/10 border border-slate-100 flex flex-col md:flex-row items-center gap-2 max-w-4xl mx-auto">
                        ...
                        <button className="w-full md:w-auto bg-[#4640DE] hover:bg-[#3b2ecc] text-white px-6 md:px-10 py-5 font-semibold transition-all shadow-xl shadow-blue-600/20 whitespace-nowrap">
                            Search
                        </button>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex-grow">
                        <div className="flex justify-between items-center mb-10">
                            <div>
                                <h2 className="text-[14px] md:text-[28px] font-clash-display font-semibold text-[#25324B]">All Jobs</h2>
                                <p className="text-[12px] md:text-[16px] text-[#7C8493]">Showing {jobs?.length || 0} results</p>
                            </div>
                            <div className="flex items-center gap-2 md:gap-3 ">
                                <span className="text-sm text-[#7C8493]">Sort by:</span>
                                <select className="bg-white border border-slate-100 rounded-lg px-2 md:px-4 py-2 text-sm outline-none font-medium text-[#25324B]">
